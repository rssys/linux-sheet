...
# execute the program with the data file and delete a column
python3 $program_path $data_file "testing" ec $output_file_1

# try deleting a column outside of the data, nothing should happen
python3 $program_path $data_file "testing" :1,7 ec $output_file_2
