...
# execute the program with the data file and delete a row
python3 $program_path $data_file "testing" er $output_file_1

# try deleting a row outside of the data, nothing should happen
python3 $program_path $data_file "testing" :7,1 er $output_file_2
